...
>
> - O Programador Web estrutura em _front-end_ e desenvolve em _back-end_, publicando aplicações web. Para isto, elabora projetos e testes ao longo do desenvolvimento e permite o acesso a banco de dados por meio de linguagens de programação, seguindo padrões internacionais.
> - Esse profissional trabalha no desenvolvimento de _sites_ institucionais, _blogs_, fóruns, lojas virtuais e diversos sistemas e aplicações voltados para o ambiente de internet e intranet, conforme políticas de segurança da informação e com respeito à propriedade intelectual.
...
>[!tip]- Competências que compõem o perfil do Programador _web_
>
> - Elaborar projetos de aplicações para _web_.
> - Estruturar aplicações _front-end_ para _web_.
> - Desenvolver aplicações _back-end_ para _web_.
> - Publicar aplicações _web_.
