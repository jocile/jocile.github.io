...
```mermaid
timeline
    title História do Python (Expandida)
    1989 : Guido van Rossum começa a trabalhar no projeto do Python
    1991 : Versão 0.9.1 do Python é lançada
    1994 : Versão 1.0 do Python é lançada
    2000 : Versão 2.0 do Python é lançada, marcando um ponto de inflexão na popularidade da linguagem
    2008 : Django, um framework web popular, é lançado com o Python como base
    2010s : O Python se torna uma das linguagens mais populares em cursos universitários e escolares
    2015 : Versão 3.x do Python é lançada, trazendo melhorias significativas na performance e segurança
    2020s : O Python continua a ser amplamente utilizado em áreas como ciência de dados, automação, desenvolvimento web e mais
    1989-1994 : O Python começa a ganhar popularidade entre desenvolvedores
    2000-2010 : A linguagem se torna mais conhecida e utilizada em projetos de código aberto
    2015-presente : O Python se estabelece como uma das linguagens mais populares e versáteis do mundo
```
